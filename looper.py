...
def index_to_model_path(i):
	return os.path.join(args.prefix, "models", "model-%03i/" % i)
...
""",
	...
	parser.add_argument("--game-count", metavar="N", type=int, default=1000, help="Minimum number of games to generate per iteration.")
